...
import com.organic.shop.controller.AdminAccountController;
...
@RestController
public class AdminAccountControllerImpl extends BaseAdminHomeController implements AdminAccountController {
    @Autowired
