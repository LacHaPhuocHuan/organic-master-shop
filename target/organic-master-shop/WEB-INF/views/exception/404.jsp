...
<body class="bg-purple">
    ...
    <div class="stars">
        ...
        <div class="central-body">
            <img class="image-404" src="https://th.bing.com/th/id/R.1279eb382944db1b5cfc8009ec793541?rik=s1v255zpU9VqUw&pid=ImgRaw&r=0" width="300px">
            <a href="<c:url value='/api/u/home'/>" class="btn-go-home" target="_blank">GO BACK HOME</a>
            <p>WEB đã gặp vấn đề rồi, xin thứ lỗi cho tại hạ vì sự bất tiện này!</p>
        </div>
        <div class="objects">
