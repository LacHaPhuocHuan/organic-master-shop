	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/assets/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="<c:url value='/api/v/auth/login/sign-in'/>">
				...
				<div class="text-center p-t-90">
					...
					<a class="txt1" href="<c:url value='/api/v/auth/register/sign-up'/>">
						&nbsp;&nbsp;&nbsp;Register?
					</a>
				</div>
			</div>
